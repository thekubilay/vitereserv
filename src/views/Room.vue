      ...
      <div v-if="!isRest" class="template__Wrapper">
        <div class="container">
          <div class="header-container">
            ...
            <p v-if="['746935619','600799837'].includes(route.params.rid as string)"
                class="room-body-summary">
              <span style="color:#e45700;">*Dates and times shown are all in Japan Standard Time. (JST/UTC+9 hours)</span><br>
              <a
